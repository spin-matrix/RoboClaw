...
class YOLODetector:
    ...
    def _capture_loop(self):
        ...
        # Wait for first valid frame to get intrinsics
        ...
        while not intr_initialized:
            ...
            # Get intrinsics from metadata
            # metadata is expected to contain camera intrinsics as a 3x3 matrix or flat list
        ...
        try:
            while self.is_running.value:
                ...
                # Resize if necessary to match expected shape
                ...
                # depth_image from ImageClient is already in meters (float32)
