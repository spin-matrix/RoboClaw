...
class ImageServer:
    def __init__(self, cam_config, realsense_enable=False, camera_finder_verbose=False, isaacsim_enable=False):
        ...
        self._responser = ZMQ_Responser(self._cam_config, port=cam_config["head_camera"]["zmq_res_port"])
        self._rgbd_responser = ZMQ_RGBDResponser(self, host="0.0.0.0", port=cam_config["head_camera"]["zmq_rgbd_res_port"])
